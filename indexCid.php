    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="cadastroCid.php">Cadastrar cidade</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="indexEst.php">Estados</a>
            </li>
            <ul>
        </div>
        </div>
...
<br><br><br>
    ...
    while ($linha = $consulta->fetch(PDO::FETCH_ASSOC)) {   
        ...
        <tr><td><?php echo $linha['cidId'];?></td>
            ...
            <td><a href='cadastroCid.php?acao=editar&cidId=<?php echo $linha['cidId'];?>'> <img class="center" src="img/edit.png" alt=""></a></td>
            <td><?php echo " <a href=javascript:excluirRegistro('acaoCid.php?acao=excluir&cidId={$linha['cidId']}')>Excluir cidade</a><br>"; ?></td>
